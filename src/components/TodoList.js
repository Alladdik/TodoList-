...
<Modal 
          ...
          >
            ...
            <Modal.Body>
              ...
              <p className="text-danger"><strong>Увага:</strong> Ця дія незворотна.</p>
            </Modal.Body>
            <Modal.Footer>
        ...
        <motion.div
          ...
          className="text-center login-prompt-container"
        >
          <Card className="mx-auto shadow-lg" style={{ maxWidth: '400px' }}>
            <Card.Body>
              <motion.h3 
                className="login-prompt-title mb-4"
                initial={{ scale: 0.9 }}
                animate={{ scale: 1 }}
              ...
              <p className="login-prompt-text mb-4">
                Будь ласка, увійдіть, щоб побачити ваші справи.
              </p>
              <div className="d-flex justify-content-center">
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button variant="primary" className="login-prompt-button" href="/login">
                    Увійти
                  </Button>
                </motion.div>
              </div>
